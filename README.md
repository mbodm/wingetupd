...
- This means: All you have to do, is to edit the package-file and insert the _WinGet_-Package-ID´s of your installed software there. When `wingetupd.exe` is called, it will try to update all that packages.
