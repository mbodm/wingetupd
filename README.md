...
[_WinGet_](https://docs.microsoft.com/de-de/windows/package-manager/winget) is imo a __fantastic!__ tool, to manage all your Windows applications and keep your Windows software up2date. Fat kudos to Microsoft! :thumbsup: For more information about _WinGet_ itself, take a look at: https://docs.microsoft.com/de-de/windows/package-manager/winget
