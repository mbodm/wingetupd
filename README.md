...
- The source is using the TAP pattern of .NET, including concurrency concepts like `async/await` and `Progress<>`.
- `wingetupd.exe` just exists, because i´m lazy and made my life a bit easier, by writing this tool. :grin:
